...
function changeOwner(address _to) public{
    require(msg.sender == contractOwner, "you are not onwer of this contract");
    newOwner = _to;
}


function acceptOwner() public {
    require( msg.sender == newOwner, "only new assign onwer can call it");
...
require(tokenBalances[msg.sender] >=_value, "insuffient token");
...
require(allowedBal >= _value, "induffient token");
